...
local lspf = require("rafa.plugin.servers.lsp_functions")
...
-- Lua
local lsp_lua = require("rafa.plugin.servers.lsp_lua")
...
-- Goland config
local lsp_go = require("rafa.plugin.servers.lsp_go")
...
-- Python server lsp
local lsp_py = require("rafa.plugin.servers.lsp_pyright")
...
-- C/C++ server lsp
local lsp_c = require("rafa.plugin.servers.lsp_clangd")
...
local lsp_cmk = require("rafa.plugin.servers.lsp_cmake")
...
-- C# language server
local lsp_cssharp = require("rafa.plugin.servers.lsp_cssharp")
...
-- Asm-lsp
local lsp_asm = require("rafa.plugin.servers.lsp_asm")
...
local lsp_tss = require("rafa.plugin.servers.lsp_tsserver")
...
-- HTML
local lsp_html = require("rafa.plugin.servers.lsp_html")
nvim_lsp.html.setup {
  on_attach = lspf.on_attach,
  capabilities = lspf.capabilities,
...
-- CSS
local lsp_css = require("rafa.plugin.servers.lsp_css")
...
local lsp_esl = require("rafa.plugin.servers.lsp_eslint")
...
-- local tlwcss = require("rafa.plugin.servers.lsp_tailwindcss")
